...
It aims to be an application of the abstract ideal [eidotha](https://github.com/kjelloh/eidotha)

The namne is a word play on the greek word 'phyros' menaing 'fire' and 'Tha' which the the working name of the four meta tier data model eluded to in YouTube playlist ['C++ Tha Tha'](https://www.youtube.com/watch?v=zdF_evtjJGg&list=PLl2MXgNWEbwE34Cxjx9uW-wdq7RyZ_uQj).
...
## The PyroTha data model representation should be implementation agnostic
